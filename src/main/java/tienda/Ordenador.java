...
public class Ordenador {
	...
	public Ordenador(double precio, String marca, PlacaBase placaBase,
					Procesador procesador, ArrayList<Ram> listaRam,
					ArrayList<Periferico> listaPerifericos, ArrayList<TarjetaGrafica> lisTarjetaGraficas ) {
		...
		this.listaTarjetasGraficas = lisTarjetaGraficas;
	}
